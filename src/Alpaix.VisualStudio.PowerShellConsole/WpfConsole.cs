...
namespace NuGetConsole.Implementation.Console
{
    ...
    internal class WpfConsole : ObjectWithFactory<WpfConsoleService>, IDisposable
    {
        ...
        {
            get { return ServiceProvider.GetService(typeof(SVsUIShell)) as IVsUIShell; }
        }
        ...
        private IVsStatusbar VsStatusBar
        {
            get
            {
                ...
                {
                    _vsStatusBar = ServiceProvider.GetService(typeof(SVsStatusbar)) as IVsStatusbar;
                }
                return _vsStatusBar;
            }
        }
        ...
        {
            get { return ServiceProvider.GetService(typeof(IOleServiceProvider)) as IOleServiceProvider; }
        }
        ...
        public SnapshotSpan AllInputExtent
        {
            get
            {
                var start = InputLineStart.Value;
