    ...
    public class PowerShellConsoleToolWindow : ToolWindowPane, IOleCommandTarget
    {
        ...
        private IWpfConsole WpfConsole
        {
            get
            {
                if (_wpfConsole == null)
                {
                    _wpfConsole = PowerConsoleWindow.ActiveHostInfo.WpfConsole;
                }
        ...
        /// </summary>
        private IComponentModel ComponentModel => GetService(typeof(SComponentModel)) as IComponentModel;
        ...
        private IPowerConsoleWindow PowerConsoleWindow => ComponentModel.GetService<IPowerConsoleWindow>();
